...
$con=mysqli_connect("localhost","root","");
    ...
    if(isset($_POST['submit'])){
        ...
        $rno2=$_POST['rollno2'];
        $part3=$_POST['participant3'];
        $rno3=$_POST['rollno3'];
        $part4=$_POST['participant4'];
        $rno4=$_POST['rollno4'];
        $part5=$_POST['participant5'];
        $rno5=$_POST['rollno5'];
        $shift=$_POST['shift'];
        $class=$_POST['class'];

        $sql="insert into ads (participant1,rollno1, participant2,rollno2, participant3,rollno3, participant4,rollno4, participant5,rollno5, shift,class) 
                              values('$part1', '$rno1', '$part2','$rno2', '$part3', '$rno3', '$part4','$rno4', '$part5','$rno5', '$shift', '$class')";
...
<head>
    ...
    <title>Ads Craze registration</title>
      ...
      <div class="row justify-content-center align-items-center h-130">
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; background-color:  #E0E5EC; ">
            ...
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Ads-Craze Registration</h3>
            ...
            <form method="post" action="" id="register-form">
                ...
                <div class="row">
                  <p>Third participant</p>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
        
                    <input type="text" name="participant3" class="form-control form-control-lg rounded-pill border"/>
                    <label class="form-label" for="Name">Name</label>
                    </div>      
                  </div>
                  ...
                  <div class="col-md-6 mb-4">      
                    <div class="form-outline">
                    <input type="text" name="rollno3" class="form-control form-control-lg rounded-pill" />
                    <label class="form-label" for="Rollno3">Roll Number</label>
                    </div>     
                  </div>
                </div>

                <div class="row">
                  <p>Fourth participant</p>
                  <div class="col-md-6 mb-4">     
                    <div class="form-outline ">
                   
                    <input type="text" name="participant4" class="form-control form-control-lg rounded-pill"/>
                    <label class="form-label" for="Name">Name</label>
                    </div>
                  ...
                  <div class="col-md-6 mb-4">     
                    <div class="form-outline">
                    <input type="text" name="rollno4" class="form-control form-control-lg rounded-pill border"/>
                    <label class="form-label" for="Rollno4">Roll Number</label>
                    </div>     
                  </div>
                </div>

                <div class="row">
                  <p>Fifth participant</p>
                  <div class="col-md-6 mb-4">     
                    <div class="form-outline ">
                   
                    <input type="text" name="participant5" class="form-control form-control-lg rounded-pill"/>
                    <label class="form-label" for="Name">Name</label>
                    </div>
                  ...
                  <div class="col-md-6 mb-4">     
                    <div class="form-outline">
                    <input type="text" name="rollno5" class="form-control form-control-lg rounded-pill border"/>
                    <label class="form-label" for="Rollno5">Roll Number</label>
                    </div>     
                  </div>
                </div>
