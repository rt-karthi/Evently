...
$con=mysqli_connect("localhost","root","");
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="insert into ppt (participant1,rollno1,participant2,rollno2,shift,class,topic) 
                              values('$part1', '$rno1', '$part2','$rno2', '$shift', '$class','$topic')";
...
<head>
    ...
    <title>paper presetation registration</title>
      ...
      <div class="row justify-content-center align-items-center h-130">
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; background-color:  #E0E5EC; ">
            ...
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Paper Presentation Registration</h3>
            ...
            <form method="post" action="" id="register-form">
                ...
                <div class="row">
                <div class="col-12">
                    <label class="form-label select-label">Topic</label>
                    <select name="topic" class="select form-control-lg rounded-pill  border border-info" style="background-color: #f3f7fa;">
                    <option  selected>select topic</option>
                    <option value="The World of Blockchain">The World of Blockchain</option>
                    <option value="Sixth Sense Technology:Concept vs Reality">Sixth Sense Technology:Concept vs Reality</option>
                    <option value="E-Learning">E-Learning</option>
                    <option value="5G Wireless Technology:Hope vs Hype">5G Wireless Technology: Hope vs Hype</option>
                    <option value="Cyberspace Security">Cyberspace Security</option>               
                    </select>     
                </div>
                </div>
