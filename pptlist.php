...
<head>
    ...
    <title>paper presentation participant list</title>
        ...
        <div class="col">
          <div class="card mt-2">
            <div class="card-header">
              <h2 class="display-5 text-center">PAPER PRESENTATION</h2>
              ...
              <table class="table table-bordered text-center">
                ...
                <tbody>
                  <?php 
                      ...
                      $sql="select participant1, rollno1, participant2, rollno2, shift, class, topic from ppt";
