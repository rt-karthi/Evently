...
<head>
    ...
    <title>ads craze participant list</title>
...
<body>
        ...
        <div class="col">
          <div class="card mt-2">
            <div class="card-header">
              <h2 class="display-5 text-center">ADS CRAZE</h2>
    ...
    <?php 
        ...
        $sql="select participant1, rollno1, participant2, rollno2, participant3, rollno3, participant4, rollno4, participant5, rollno5, shift, class from ads";
        ...
        echo" <tr>
            ...
            <td>".$row["rollno2"]."</td>
            <td>".$row["participant3"]."</td>
            <td>".$row["rollno3"]."</td>
            <td>".$row["participant4"]."</td>
            <td>".$row["rollno4"]."</td>
            <td>".$row["participant5"]."</td>
            <td>".$row["rollno5"]."</td>
            <td>".$row["shift"]."</td>
            <td>".$row["class"]."</td>                               
        </tr> ";
